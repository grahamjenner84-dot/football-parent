...
export const metadata = generateSEO({
  ...
  description: "What grassroots football means in the UK, the ages it covers, how it differs from academy football, and whether it's the right environment for your child.",
