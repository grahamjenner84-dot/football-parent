...
description: "The FA's FutureFit reforms start in 2026/27 and change match sizes at nearly every age group between Under-7 and Under-14. What's actually changing, and why."
date: "2026-06-20"
...
"On larger pitches with more players, individuals typically receive less touches of the ball, complete fewer technical actions, make a reduced number of decisions and have restricted opportunities to solve problems in realistic game situations."

Read Paul's full answer in our interview, [FutureFit Part 2: Why 3v3 Matters and 11v11 Is Being Delayed](/parent-guides/futurefit-football-dna-interview-part-2).
</ExpertOpinion>
...
Physical size and strength differences between children born early and late in the same school year tend to widen as games get bigger and more physically contested, because greater space and more direct contact reward bigger, faster players more heavily. This is part of why some academies use [bio-banding](/football-development/bio-banding-football) as a complementary tool to chronological age groups, grouping players by physical maturity rather than school year for specific tournaments or sessions. By keeping children in smaller, more technical formats for an extra year before they reach 11v11, there's a reasonable argument that the new structure slightly reduces how much raw physical advantage can dominate selection and playing time during that window.
...
**Development focus.** This kind of structural change tends to land better with parents when clubs frame it around what the child gains (more touches, more involvement, more decision-making) rather than simply announcing a rule change. Parents are generally receptive to format changes once they understand they're not arbitrary.
...
- [FutureFit interview with Football DNA part 2](/parent-guides/futurefit-football-dna-interview-part-2)
