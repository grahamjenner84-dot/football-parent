...
description: "West Ham's academy and the Foundation's Player Pathway aren't the same thing. How each route actually works, and which one most east London families join."
date: "2026-06-20"
...
Under EPPP regulations, Category 1 clubs can register players from Under-9. If a player moves between Category 1 clubs, a fixed compensation fee applies. If the receiving club is Category 2 or below, different rules apply - see our guide to [football academy categories](/academy-pathway/academy-categories-explained) for what separates each tier.
...
- [Tottenham Development Centres Explained](/academy-pathway/tottenham-development-centres-explained)
