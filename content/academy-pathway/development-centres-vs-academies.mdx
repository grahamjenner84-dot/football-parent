...
A football academy is a youth development programme operated by a professional club under the EPPP framework. To run a Category 1-4 academy, a club must be independently audited and maintain category standards. Our guide to [academy categories explained](/academy-pathway/academy-categories-explained) breaks down what separates each category in practice. To run a Category 1-4 academy, a club must be independently audited and maintain category standards.
