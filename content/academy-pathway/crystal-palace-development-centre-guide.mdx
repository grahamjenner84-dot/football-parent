...
description: "Crystal Palace's pathway has three tiers before the Academy: open, invite-only, then the Talent Centre. How it works for south London and Kent families."
date: "2026-06-06"
...
Parents can view the current structure of the official [Palace Player Pathway](https://www.palaceforlife.org/course/player-development-emerging-talent/) on the Palace for Life website.
...
<ParentNote>
When my son first started at Crystal Palace, they gave him a workbook. Each week had a different subject, for example getting into space, with a page to fill in about what the session had been about and what he'd learned. He was probably a little young to get the full value from it, but I thought it was a genuinely good way of getting children to think about and reflect on what they'd learned each session.
</ParentNote>
...
Parents can find the latest information on pathway progression and Talent Centre opportunities through the official [Palace Player Pathway](https://www.palaceforlife.org/course/player-development-emerging-talent/).
...
Parents of goalkeepers should check current availability and locations directly with [Palace for Life](https://www.palaceforlife.org/course/player-development-emerging-talent/), as goalkeeper-specific sessions run at fewer venues than the outfield centres.
...
<ParentNote>
At Crystal Palace, they let my son try a session before he committed to anything. He was there for the full season, with regular check-ins on how he was progressing. He didn't move up a tier, but he was often placed in a mixed age group, which gave him a good level of challenge playing against older boys each week.
</ParentNote>
...
Trial sessions for the girls' pathway are held periodically rather than on a fixed annual cycle, so it's worth checking directly with [Palace for Life](https://www.palaceforlife.org/course/player-development-emerging-talent/) for current availability. Our broader guide to [how girls' football academies work](/girls-football/how-girls-football-academies-work) explains how this kind of pathway typically connects into a club's senior women's team structure.
