...
sections:
  ...
  - id: "etc-elite-training-centre"
    title: "ETC - Elite Training Centre"
...
As a **Player Training Centre**, it is closer in meaning to a PDC - a training environment rather than a formal assessment process.
...
**What it usually means:**
The RTC term is most widely used in the women's and girls' game, where it has a specific meaning within the FA's talent pathway for female players.

In the girls' game, RTCs are licenced programmes run by clubs and organisations to identify and develop talented female players across defined catchment areas. They are a recognised part of the formal pathway and are governed by the FA's Women's Football strategy.
...
RTCs in the women's pathway are genuinely significant. They are part of a structured route towards professional women's football and are more formally regulated than many boys' equivalent programmes. Our dedicated guide to [girls' RTCs explained](/girls-football/girls-rtcs-explained) covers this in detail.
...
**What it usually means:**
The ETC label appears occasionally and generally implies a programme sitting at a slightly higher level than a standard development centre - positioned between a development centre and formal academy registration, or used to describe satellite facilities of larger clubs.

Like the other terms, ETC is not standardised. A few clubs use it; many do not.

If you encounter this term, the same questions apply: what does the programme involve, what is the commitment, and how does it connect to the club's main structure?
...
The phrase "Centre of Excellence" has particular history in women's and girls' football, where it was used before the current RTC structure was introduced. If you encounter it today, it is worth checking whether the programme is a licenced RTC or a standalone coaching product.
