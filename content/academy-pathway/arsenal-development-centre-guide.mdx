...
description: "Arsenal's academy is Category 1 and based at Hale End, but there's no public development centre to apply to. How the pathway works, and what to do if scouted."
date: "2026-06-06"
...
sections:
  ...
  - id: "does-arsenal-have-a-development-centre"
    title: "Does Arsenal Have A Development Centre?"
  - id: "the-hale-end-academy"
    title: "The Hale End Academy"
  - id: "arsenal-development-centre-locations"
    title: "Arsenal Development Centre Locations"
  - id: "arsenal-development-centre-trials"
    title: "Arsenal Development Centre Trials"
...
Category 1 status means Arsenal can recruit from a broader geographic catchment than lower-category clubs and invest significantly in [player welfare and education](https://www.premierleague.com/en/footballandcommunity/morethanagame/wider-football/academies-and-player-welfare), including scholar apprenticeships and dual career support. It also means the standard required to enter and remain in the formal academy is high.
...
It's worth being upfront about one thing before we go further. Unlike some clubs, Arsenal does not currently publish a single, clearly named development centre programme with public information on locations, fees or how to book a place. Where other clubs make this information freely available, Arsenal's pathway below Academy level is less visible from the outside. This guide explains what is publicly known and how the wider pathway works, but parents should expect to contact the club directly for current, specific programme details.

---

## How Arsenal Structure Their Youth Pathway

Arsenal's youth setup broadly follows the Premier League's [Elite Player Performance Plan](https://www.premierleague.com/en/footballandcommunity/youth-development/eppp) framework. The key phases are:
...
For families considering Arsenal's pathway, the Hale End location is an important practical factor. Weekly sessions in east London require realistic travel assessment, particularly for families from further afield. If you're weighing Arsenal against other options nearby, our guide to [football development centres in London](/academy-pathway/football-development-centres-in-london) compares travel and access across multiple clubs.
...
**Development centre involvement is not the same as academy registration.** If your child is attending a programme that is not formally part of the EPPP academy, they are not an Arsenal academy player. This distinction matters for managing expectations, and for understanding what obligations (if any) either party has. Our guide to [development centres vs academies](/academy-pathway/development-centres-vs-academies) explains this distinction in more detail and is worth reading regardless of which club's pathway your child is on.
...
Arsenal are not the only club recruiting in north London. Tottenham Hotspur run their own Category 1 academy, alongside a separate set of invitation-only and 15-21 programmes covered in our [Tottenham development centres guide](/academy-pathway/tottenham-development-centres-explained), and a number of Championship and League One clubs have development programmes across the broader London area.
...
### Is my child an Arsenal academy player if invited to a development session?

Development Centre sessions are often paid for, and provide good quality coaching to grassroots players. They can sometimes lead to further opportunities with the academy, but progression isn't guaranteed, and most participants will not move beyond the development programme.
...
### What are the age groups in the Premier League Academy?

Three broad phases: the Foundation Phase (U9-U11), focused on technical development; the Youth Development Phase (U12-U16), where training becomes more frequent and technically demanding; and the Professional Development Phase (U17-U21), the upper academy connected directly to the first team. Most clubs, including Arsenal, also run pre-academy or development-level programmes below U9 under various names.
