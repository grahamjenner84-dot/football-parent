...
<InfoTable data='[
  {"label":"Club membership","value":"Monthly or termly subscription"},
  {"label":"League registration","value":"Annual player registration"},
  {"label":"Match kit","value":"Varies by club"},
  {"label":"Training kit","value":"Often compulsory"},
  {"label":"Tournament entry","value":"Some clubs charge separately"},
  {"label":"Away travel","value":"Fuel, parking or occasional accommodation"}
]' />
