...
This is **Part 1** of a two-part interview. You can read [Part 2 of our FutureFit interview with Football DNA](/parent-guides/futurefit-football-dna-interview-part-2) for Paul's answers to the second six questions.
...
Under the FA’s new FutureFit framework, [youth grassroots football](/parent-guides/what-is-grassroots-football) is shifting down to a smaller-sided game format for U7s (3v3) and delaying 11 a-side until the U14s season, thereby allowing another season at 9v9 for U13s age groups. 
