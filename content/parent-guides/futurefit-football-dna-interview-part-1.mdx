...
To learn more about Football DNA's coaching philosophy, courses and resources, visit [Football DNA](https://footballdna.co.uk). Football DNA is a really useful app where you can get thousands of drills to run in your coaching sessions. It allows you to search for topics and to filter by age group. As well as giving you a full session plan it also allows you to watch top coaches like Paul delivering the content so you can unndersand the key coaching points and how to advance or regress the session depending on the group you are coaching. It's genuienly an amazing source of information and can even be used if you wanted to do 1-1 stuff with your child and want some ideas.
