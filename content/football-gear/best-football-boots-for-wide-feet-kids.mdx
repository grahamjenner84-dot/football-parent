...
**[Nike Jr. Tiempo Legend 10](https://amzn.to/4iXxNZK)** (Academy or Club tier) is the widest-fitting boot in Nike's current range. Its FlyTouch Lite upper is designed to mould to the foot rather than hold a fixed narrow shape - similar to what leather does naturally, without the maintenance.

**[adidas Copa Pure Junior](https://amzn.to/3UJ0y2p)** fits noticeably roomier through the midfoot than Adidas's Predator or X ranges. Worth knowing before buying: the junior version uses a synthetic leather-look upper rather than real kangaroo leather, so it won't stretch and mould the way an adult Copa does, but it still fits wider than Adidas's speed boots out of the box.
