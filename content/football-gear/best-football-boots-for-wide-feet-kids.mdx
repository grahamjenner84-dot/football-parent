...
**[Nike Jr. Tiempo Legend 10](#affiliate-link-pending)** (Academy or Club tier) is the widest-fitting boot in Nike's current range. Its FlyTouch Lite upper is designed to mould to the foot rather than hold a fixed narrow shape - similar to what leather does naturally, without the maintenance.

**[adidas Copa Pure Junior](#affiliate-link-pending)** (Elite or League tier) fits noticeably roomier through the midfoot than Adidas's Predator or X ranges. Worth knowing before buying: the junior version uses a synthetic leather-look upper rather than real kangaroo leather, so it won't stretch and mould the way an adult Copa does, but it still fits wider than Adidas's speed boots out of the box.
...
This is a common and genuinely tricky situation. It's worth having an honest conversation about what happens to feet in ill-fitting boots - blisters, nail bruising, long-term discomfort. If the child is older, letting them experience one session in too-narrow boots and seeing how they feel afterwards can sometimes be more persuasive than any argument. Ultimately, a boot that causes pain will affect their enjoyment and development, and that's worth more than the brand on the side.
