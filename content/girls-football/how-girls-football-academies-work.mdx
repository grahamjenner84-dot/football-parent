...
description: "Girls academy football isn't a copy of the boys' EPPP system: entry comes later, and Emerging Talent Centres have no male equivalent. How the pathway works."
date: "2026-06-02"
category: "Girls Football"
categoryUrl: "/girls-football"
readTime: 9
sections:
  - id: "the-girls-football-pathway-an-overview"
    title: "The Girls Football Pathway: An Overview"
  - id: "how-players-get-into-the-pathway"
    title: "How Players Get Into The Pathway"    
  - id: "what-are-regional-talent-clubs"
    title: "What Are Regional Talent Clubs?"
  - id: "wsl-and-championship-club-academies"
    title: "WSL and Championship Club Academies"
  - id: "how-girls-academies-differ-from-boys"
    title: "How Girls Academies Differ From Boys"
  - id: "development-centres-vs-academies"
    title: "Development Centres vs Academies"
  - id: "what-actually-matters-for-development"
    title: "What Actually Matters for Development"
...
## How Players Get Into The Pathway

There is no single route into girls academy football.

Players may be identified through grassroots football, school football, county FA activity, Emerging Talent Centres, development centres or talent identification programmes such as Discover My Talent.

In many cases, players are observed over a period of time rather than being selected from a single trial. Coaches are often looking for long-term potential, enjoyment of the game and the ability to learn, rather than simply current performance.

For parents, this means the focus should remain on development rather than visibility. Good coaching environments are usually more important than constantly searching for opportunities to be seen.

---

## RTCs, ETCs and the Modern Girls Pathway

Regional Talent Clubs (RTCs) used to be an important part of the girls' pathway that has no direct equivalent in the boys' game. RTCs were replaced by Emerging Talent Centres (ETCs). You can read more in our article on [Girls RTCs Explained: What They Were and What Replaced Them](/girls-football/girls-rtcs-explained).
...
The FA website holds a directory of licensed ETCs. You can find them here: [Emerging talent centre directory](https://www.englandfootball.com/england/youth/womens-talent-pathway/emerging-talent-centres)
