...
sections:
  ...
  - id: "how-players-get-into-etcs"
    title: "How Players Get Into ETCs"    
...
## How Players Get Into ETCs

There is no single route into an Emerging Talent Centre.

Players may be identified through grassroots football, school football, county FA activity, development programmes or talent identification events. Coaches and scouts working within the pathway can also recommend players for observation.

In some areas, referral opportunities may be available through recognised talent identification processes. In others, clubs and centres rely more heavily on scouting and observation.

The important thing for parents to understand is that ETC selection is based on potential rather than current achievement. Coaches are often looking for players who show qualities that could develop over time rather than simply the strongest performer in a particular match.
...
**Are RTCs still operating?**

No. RTCs have been replaced by Emerging Talent Centres (ETCs) and Professional Game Academies (PGAs) within the current FA pathway.

**Can my daughter play grassroots football while attending an ETC?**

Yes. ETCs are designed to complement grassroots football rather than replace it.

**Does being in an ETC guarantee progression to a PGA?**

No. ETCs provide development opportunities, but progression depends on many factors and is not automatic.

**What age can girls join an ETC?**

Most ETCs work with players aged 8 to 16, although exact age-group structures may vary slightly between centres.
