...
If you have searched for "girls RTCs" recently, you are not alone. Many parents still use this term when asking about their daughter's development pathway. But RTCs no longer exist in the way they once did. The FA restructured the entire women's and girls' talent pathway from 2022 onwards, replacing Regional Talent Centres with a new system designed to reach more players across the country.

This article explains what RTCs were, why the system changed, and what the current pathway looks like for talented girls today.
