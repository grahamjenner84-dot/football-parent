...
relatedArticles:
  ...
  - href: "/football-development/late-developers-in-football"
    ...
    description: "Understanding late development in football."
---
...
**Confidence-related late development** refers to players who have the ability but whose belief in themselves - on the pitch, in a trial environment, under scrutiny - lags behind. This is more common in girls' football than it's often acknowledged.
...
The relative age effect (the tendency to favour players born earlier in the school year) is well-documented in boys' football. In girls' football, it applies too - but it's compounded by the even wider variation in physical maturation.
