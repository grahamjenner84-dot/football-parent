# Football Parent — Valid Existing URLs & Internal Linking Rules

Source of truth: footballparent.co.uk sitemap (last synced from a sitemap
export). Use this file whenever writing or checking internal links. Never
invent a URL — if a slug isn't on this list AND isn't a new article created
in the current batch, do not link to it.

## Cluster priority

When choosing internal links, prefer in this order:
1. Same content cluster
2. Relevant pillar article
3. Closely related supporting content

Primary clusters, in order of topical authority:
1. Academy Pathway
...
Avoid linking to Football Gear articles unless the article is specifically about equipment.
...
on the assumption they're still live. Flag it if any of them have moved.)
...
For academy, pathway and trial articles, look for natural opportunities to link to:
- /academy-pathway/development-centres-vs-academies
- /academy-pathway/how-academy-football-works
- /academy-trials/how-football-clubs-recruit-young-players
- /academy-trials/what-do-academy-coaches-look-for
...
For football development articles:
- /football-development/how-much-training-is-too-much
- /football-development/good-football-development-environment
- /football-development/late-developers-in-football
- /football-development/build-confidence-young-footballers
...
For Junior Premier League (JPL) articles, look for natural opportunities to link to:
- /parent-guides/what-is-the-junior-premier-league
- /parent-guides/jpl-vs-grassroots-football
- /parent-guides/jpl-and-academy-football
- /parent-guides/how-to-get-into-the-jpl
...
- Use only URLs from this list, or new article URLs created in the current batch.
- 3–5 contextual internal links inside the article body, placed behind natural anchor text.
- 3–4 links in the bottom "Related Articles" section, kept separate from body links.
- Never repeat the same internal link excessively in one article.
- Do not force a link where it interrupts readability — if it feels forced, cut it.
- Never guess or invent a slug. If unsure a URL exists, don't link it.
